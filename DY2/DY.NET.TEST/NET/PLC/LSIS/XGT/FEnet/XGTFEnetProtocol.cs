...
namespace DY.NET.LSIS.XGT
{
    ...
    public class XGTFEnetProtocol : IProtocol
    {
        ...
        public static XGTFEnetProtocol CreateRequestWSS(Type type, IList<IProtocolItem> data)
        {
            return new XGTFEnetProtocol(type, XGTFEnetCommand.WRITE_REQT) { Items = data };
        }

        public static XGTFEnetProtocol CreateRequestRSS(Type type, IList<IProtocolItem> data)
        {
            return new XGTFEnetProtocol(type, XGTFEnetCommand.READ_REQT) { Items = data };
        }
