...
namespace DY.NET.TEST.TEST.XGTFEnet
{
    ...
    public class XGTFEnetStreamTest
    {
        ...
        public async void WhenFakeXGTFENetStreamFloated_ExpectedWriteTimeoutException()
        {
            ...
            var type = XGTFEnetDataType.WORD;
        ...
        [Test]
        [TestCase(XGTFEnetCommand.READ_RESP)]
        ...
        public async void WhenFakeXGTFEnetStreamFloated_ReceivedSuccessfully(XGTFEnetCommand expected_cmd)
        {
            ...
            XGTFEnetProtocol expectedResult = new XGTFEnetProtocol(expected_cmd, XGTFEnetDataType.WORD)
            {
                ...
                SlotPosition = 0,
                BasePosition = 3,
                Items = new List<IProtocolData>() { new ProtocolData("%MW100", value) }
            };
            string addr = "%MW100";
            ...
            if (expected_cmd != XGTFEnetCommand.WRITE_RESP)
