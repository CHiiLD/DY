...
namespace DY.NET.TEST.TEST.XGTFEnet
{
    ...
    public class XGTFEnetCompressorTest
    {
        ...
        public void WhenResponseProtocolEncode_ExpectArgumentException()
        {
            string addr = "%MW100";
            ushort tag = 0x00;
            XGTFEnetProtocol fenet = new XGTFEnetProtocol(XGTFEnetCommand.READ_RESP, XGTFEnetDataType.WORD);
            fenet.Items = new System.Collections.Generic.List<IProtocolData>() { new ProtocolData(addr) };
            fenet.InvokeID = tag;
        ...
        public void WhenWSSProtocolCompressorEncode_CompressSuccessfully()
        {
            ...
            0x02, 0x00,
            0x34, 0x12 };
            XGTFEnetProtocol fenet = new XGTFEnetProtocol(XGTFEnetCommand.WRITE_REQT, XGTFEnetDataType.WORD);
        ...
        {
            XGTFEnetProtocol expectedResult = new XGTFEnetProtocol(XGTFEnetCommand.READ_RESP, XGTFEnetDataType.WORD)
            {
        ...
        {
            XGTFEnetProtocol expectedResult = new XGTFEnetProtocol(XGTFEnetCommand.WRITE_RESP, XGTFEnetDataType.WORD)
            {
                CompanyID = XGTFEnetCompanyID.LSIS_XGT,
                CpuType = XGTFEnetCpuType.XGK_CPUH,
                Class = XGTFEnetClass.MASTER,
