namespace DY.NET.DATALOGIC.MATRIX
{
    ...
    public class Matrix200Command
    {
        ...
        protected readonly byte[] CMD_LED_AUTOLEARN_TIMEOUT_1000MS = { ESC, (byte)'N', (byte)'O', (byte)'1' };
#endif
        //Visiset 패킷 캐치 코드
        ...
        //코드 인식
        protected readonly byte[] CMD_VISISET_SETUP_OPEN = { 0x02, 0x00, 0x01, 0x00, 0x04, 0x4D, 0x03, 0x00, 
                                                             0x57, 0x02, 0x00, 0x01, 0x00, 0x32, 0x0A, 0x03,
                                                             0x00, 0x42 };
        protected readonly byte[] CMD_VISISET_SETUP_CAPTURE = { 0x02, 0x00, 0x01, 0x00, 0x3D, 0x01, 0x03, 0x00, 
                                                                0x44, 0x02, 0x00, 0x00, 0x00, 0x3B, 0x03, 0x00, 
                                                                0x40 };
        protected readonly byte[] CMD_VISISET_SETUP_CODESETTING = { 0x02, 0x00, 0x02, 0xFE, 0x00, 0x44, 0x01, 0x00, 
                                                                    0x03, 0x00, 0x4C,
                                                                    0x02, 0x00, 0x00, 0x00, 0x3B, 0x03, 0x00, 0x40 };
        protected readonly byte[] CMD_VISISET_SETUP_CLOSE = { 0x02, 0x00, 0x01, 0x00, 0x04, 0x1B, 0x03, 0x00, 0x25 };
        protected readonly byte[] CMD_VISISET_SETUP_SAVE = {  0x02, 0x00, 0x02, 0xFE, 0x00, 0x44, 0x02, 0xFE,
                                                              0x00, 0x03, 0x00, 0x4D };

        protected readonly byte[] CMD_VISISET_LEARN_START = {  0x02, 0x00, 0x05, 0x00, 0x04, 0x59, 0x31, 0x2C, 0x34, 0x00, 0x03, 0x00, 0xF8 };
        protected readonly byte[] CMD_VISISET_LEARN_CANCLE = { 0x02, 0x00, 0x01, 0x00, 0x04, 0x1B, 0x03, 0x00, 0x25 };
    }
}